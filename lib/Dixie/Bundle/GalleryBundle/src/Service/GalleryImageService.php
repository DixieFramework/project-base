...
use Devlabs\SportifyBundle\Entity\Matches;
...
class GalleryImageService
{
     ...
     * @return Prediction
     */
    public function getPrediction(User $user, Matches $match, array $predictions)
    {
     ...
     * @return mixed
     */
    public function createForm(Request $request, array $urlParams, Matches $match, Prediction $prediction, $buttonAction)
    {
     ...
     * @param $match
     */
    public function formHandleRequest(Request $request, Form $form, Matches $match)
    {
