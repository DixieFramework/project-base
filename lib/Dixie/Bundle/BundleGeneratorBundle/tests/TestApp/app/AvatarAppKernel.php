...
class AvatarAppKernel extends Kernel
{
    ...
    public function registerBundles(): iterable
    {
        return [
            ...
            new Talav\BundleGeneratorBundle\TalavBundleGeneratorBundle(),
    ...
    {
        return sys_get_temp_dir().'/TalavBundleGeneratorBundle/cache/'.$this->getEnvironment();
    }

    public function getLogDir(): string
    {
        return sys_get_temp_dir().'/TalavBundleGeneratorBundle/logs';
    }
}
