...
//        $this->renderFile('bundle/LICENSE-'.$bundle->getLicense().'.twig', $dir.'/LICENSE.md', $parameters);
        $this->renderFile('bundle/talav_routing.yml.twig', $dir.'/src/Resources/config/talav/routing.yml', $parameters);
        $this->renderFile('bundle/composer.json.twig', $dir.'/composer.json', $parameters);

        $this->filesystem->mkdir($dir.'/src/Resources/public');
        $this->filesystem->touch($dir.'/src/Resources/public/.gitkeep');
    }
