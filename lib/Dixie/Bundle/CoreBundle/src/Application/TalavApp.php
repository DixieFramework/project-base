...
namespace Talav\CoreBundle\Application;

use Talav\CoreBundle\Exception\TalavException;
use Talav\CoreBundle\Exception\AppReadOnlyModeException;
...
class TalavApp
{
    ...
    protected static function throwExceptionOnNotInitialized(): void
    {
        if (false === self::$initialized) {
            throw new TalavException(sprintf(
