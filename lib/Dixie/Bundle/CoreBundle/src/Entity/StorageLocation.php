...
use Talav\CoreBundle\Enums\StorageLocationAdapters;
use Talav\CoreBundle\Enums\StorageLocationTypes;
use Talav\CoreBundle\Entity\Interfaces\IdentifiableEntityInterface;
use Talav\CoreBundle\Entity\Traits\IdentityTrait;
use Talav\CoreBundle\Exception\StorageLocationFullException;
use Talav\CoreBundle\Radio\Quota;
use Talav\CoreBundle\Validator\Constraints as AppAssert;
...
class StorageLocation implements Stringable, ResourceInterface
{
    use IdentityTrait;
