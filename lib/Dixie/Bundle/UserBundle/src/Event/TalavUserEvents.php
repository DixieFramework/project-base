...
final class TalavUserEvents
{
     ...
     * @Event("Talav\UserBundle\Event\GetResponseUserEvent")
     */
    public const PROFILE_EDIT_INITIALIZE = 'talav_user.profile.edit.initialize';
     ...
     *
     * @Event("Talav\UserBundle\Event\UserFormEvent")
     */
    public const PROFILE_EDIT_SUCCESS = 'talav_user.profile.edit.success';
     ...
     * This event allows you to access the response which will be sent.
     *
     * @Event("Talav\UserBundle\Event\FilterUserResponseEvent")
     */
    public const PROFILE_EDIT_COMPLETED = 'talav_user.profile.edit.completed';
     ...
     * This event allows you to modify the default values of the user before binding the form.
     *
     * @Event("Talav\UserBundle\Event\GetResponseRegistrationEvent")
     */
    public const REGISTRATION_INITIALIZE = 'talav_user.registration.initialize';
     ...
     * This event allows you to set the response instead of using the default one.
     *
     * @Event("Talav\ProfileBundle\Event\UserFormEvent")
     */
    public const REGISTRATION_SUCCESS = 'talav_user.registration.success';

    /**
     * The REGISTRATION_FAILURE event occurs when the registration form is not valid.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a Talav\UserBundle\Event\FormEvent instance.
     *
     * @Event("Talav\UserBundle\Event\FormEvent")
     */
    public const REGISTRATION_FAILURE = 'talav_user.registration.failure';
     ...
     * @Event("Talav\UserBundle\Event\GetResponseUserEvent")
     */
    public const REGISTRATION_CONFIRM = 'talav_user.registration.confirm';
