...
namespace Talav\WebBundle\Twig\Component\Sidebar;

use Talav\WebBundle\Twig\Component\Sidebar\ValueObject\Group;
use Talav\WebBundle\Twig\Component\Sidebar\ValueObject\Header;
use Talav\WebBundle\Twig\Component\Sidebar\ValueObject\Link;
use Talav\WebBundle\Twig\Component\Sidebar\ValueObject\Sidebar as SidebarValueObject;
 ...
 * Class Sidebar.
 */
#[AsTwigComponent(template: '@TalavWeb/components/sidebar.html.twig')]
final class TalavSidebar
{
    public array $data = [];
