...
namespace Talav\WebBundle\Engine;
 ...
 * @see \Talav\WebBundle\EventListener\DefaultPageAssetSetterListener::setDefaultPageAssets()
 * @see \Talav\WebBundle\Twig\Extension\AssetExtension::pageAddAsset()
 */
