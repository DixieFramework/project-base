        ...
        $formBuilder
            ...
            ->add('order', ChoiceType::class, [
                ...
                'choices' => [
                    ...
                    'search.order.login' => self::ORDER_LOGIN,
                    'search.order.comments' => self::ORDER_COMMENTS,
                    'search.order.membership' => self::ORDER_MEMBERSHIP,
                    'search.order.username' => self::ORDER_USERNAME,
                ],
                'translation_domain' => 'messages',
            ])
