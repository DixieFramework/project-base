...
use Talav\ProfileBundle\Form\DataTransformer\LocationModelToLocationTransformer;
...
{
    private LocationModelToLocationTransformer $transformer;

    public function __construct(LocationModelToLocationTransformer $transformer)
    {
    ...
    /** @param LocationModel|null $viewData */
    public function mapDataToForms($viewData, Traversable $forms): void
    {
        ...
        // invalid data type
        if (!$viewData instanceof LocationModel) {
            throw new UnexpectedTypeException($viewData, LocationModel::class);
        }
