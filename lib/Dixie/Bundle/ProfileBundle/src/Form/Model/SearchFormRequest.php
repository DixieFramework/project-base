...
class SearchFormRequest
{
    ...
    /** @var int */
    public $direction = SearchFormType::DIRECTION_DESCENDING;
    ...
    private static function fillObjectFromRequest(self $searchFormRequest, Request $request): self
    {
        ...
        $searchFormRequest->order = self::get($data, 'order', SearchFormType::ORDER_ACCOM);
        $searchFormRequest->direction = self::get($data, 'direction', SearchFormType::DIRECTION_ASCENDING);
