...
namespace Talav\ImageBundle\Service;

use Talav\ImageBundle\Exception\CorruptedFileException;
use Talav\ImageBundle\Exception\ImageDownloadTooLargeException;
...
class ImageManager
{
    ...
    public function getPath(\Talav\ImageBundle\Entity\Image $image): string
    {
        return $this->publicUploadsFilesystem->read($image->filePath);
    }

    public function getUrl(?\Talav\ImageBundle\Entity\Image $image): ?string
    {
        if (!$image) {
            return null;
        }
    ...
    public function getMimetype(\Talav\ImageBundle\Entity\Image $image): string
    {
        try {
